...
class InMemoryCorredorRepository implements ICorredorRepository {
    ...
    function __construct() {
        $this->corredores[] = new Corredor(00000000, 'Jonathan', 'Heras Vicente', 'joheras@gmail.com', '$2a$12$pgOouPm3E8mcAYT9WraLluceSUmbJFuPogELZZHPM36eBYX.iR20q', 'Calle Falsa', new \DateTime("1985-08-15"));
