...
class Corredor extends \App\CorredoresRiojaDomain\Model\Corredor implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\CorredoresRiojaDomain\\Model\\Corredor' . "\0" . 'dni', '' . "\0" . 'App\\CorredoresRiojaDomain\\Model\\Corredor' . "\0" . 'nombre', '' . "\0" . 'App\\CorredoresRiojaDomain\\Model\\Corredor' . "\0" . 'apellidos', '' . "\0" . 'App\\CorredoresRiojaDomain\\Model\\Corredor' . "\0" . 'email', '' . "\0" . 'App\\CorredoresRiojaDomain\\Model\\Corredor' . "\0" . 'password', '' . "\0" . 'App\\CorredoresRiojaDomain\\Model\\Corredor' . "\0" . 'direccion', '' . "\0" . 'App\\CorredoresRiojaDomain\\Model\\Corredor' . "\0" . 'fechanacimiento', '' . "\0" . 'App\\CorredoresRiojaDomain\\Model\\Corredor' . "\0" . 'salt');
        }
    ...
    public function isMayorEdad()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isMayorEdad', array());
